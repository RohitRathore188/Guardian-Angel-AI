      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-2xl border border-slate-200/80 rounded-3xl p-10 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.08)]">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-extrabold text-slate-900 tracking-tight">Authority Login</h1>
            <p className="text-slate-500 text-sm mt-1.5 font-medium">Sign in to access the command dashboard</p>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-slate-100 text-center">
            <Link to="/" className="text-slate-400 text-sm hover:text-slate-700 transition-colors font-medium">
              ← Back to home
            </Link>
          </div>
        </div>

...
export default function AdminPage() {
  ...
  // Seeding 40 cases, 15 hospitals, 20 police units, 25 volunteers, 12 NGOs, 8 welfare offices
  useEffect(() => {
    // If backend cases are empty, populate with generated demo ones
    if (cases.length <= 3) {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="card p-5 border border-white/10 bg-dark-900/40 h-80 flex flex-col justify-between">
                ...
                <div className="flex justify-between text-[8px] text-slate-550 uppercase tracking-widest font-bold">
                  <span>Start range (Chennai Sectors)</span>

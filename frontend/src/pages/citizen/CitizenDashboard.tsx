...
export default function CitizenDashboard() {
  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col max-w-md mx-auto relative overflow-hidden">
      ...
      {/* Header */}
      <header className="header-glass px-5 py-4 flex items-center justify-between relative z-10">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs text-slate-400 font-semibold truncate max-w-[100px]">{profile?.name || 'Citizen'}</span>
      ...
      {/* Main Content Area */}
      <div className="flex-1 overflow-y-auto px-5 py-6 space-y-6 relative z-10 scrollbar">
        {/* Large Emergency CTA */}
        <div className="card-glass-interactive p-6 border border-red-500/20 text-center relative overflow-hidden bg-red-950/10">
          ...
          <button
            ...
            className="btn-primary w-full py-4 text-sm font-bold flex items-center justify-center gap-2.5 rounded-xl shadow-lg shadow-primary/30 cursor-pointer"
          >
        ...
        <div className="grid grid-cols-2 gap-3">
          <a href="tel:1098" className="card-glass p-3.5 flex items-center gap-3 hover:border-primary/30 transition-all">
          ...
          <a href="tel:112" className="card-glass p-3.5 flex items-center gap-3 hover:border-orange-500/30 transition-all">
            ...
            {loading ? (
              ...
              notifications.slice(0, 2).map((n) => (
                <div 
                  ...
                  className="card-glass p-3.5 border border-white/5 hover:border-white/10 transition-all cursor-pointer flex gap-3 items-start"
                >
            ...
            {loading ? (
              ...
              reports.map((c) => (
                <div 
                  ...
                  className="card-glass p-4 border border-white/5 hover:border-primary/20 transition-all cursor-pointer flex gap-4 items-center justify-between"
                >
